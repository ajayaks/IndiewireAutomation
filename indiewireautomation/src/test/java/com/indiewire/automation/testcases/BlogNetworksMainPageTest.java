...
public class BlogNetworksMainPageTest {
  private WebDriver driver;
  private String baseUrl;

  private StringBuffer verificationErrors = new StringBuffer();
  private static String baseElement;
  private static final Logger LOG = LoggerFactory.getLogger(BlogNetworksMainPageTest.class);
  ...
  public void testBlogNetworksMainPageLink() throws Exception {
    ...
    try {
      ...
      for (int index = 1; index <= webElementsList.size(); index++) {
        ...
        System.out.println("Starting verification "+networkName +" main page::");
  ...
  private WebElement getWebElement(WebDriver driver, String text, boolean retry) throws Exception {
