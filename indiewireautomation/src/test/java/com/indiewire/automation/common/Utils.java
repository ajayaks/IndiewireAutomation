...
import com.indiewire.automation.testcases.IWMainPageTest;
...
public class Utils {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(IWMainPageTest.class);
  ...
  */
  ...
  public static void captureScreenShot(WebDriver driver,String fileName) {
    ...
    try {
      ...
      File targetFile = new File(screenShotLocation +fileName+System.currentTimeMillis() + ".png");
